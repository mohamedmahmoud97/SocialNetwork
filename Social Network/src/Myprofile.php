...
?>
<?php include('addprofilepicture.php') ?> 
<?php
            ...
            <div class="row">
              <div class="col-md-3">
				...
				<form method="post" action="myprofile.php" enctype="multipart/form-data">
					...
					<button class="btn btn-primary pull-right" style="padding-left: 20px;margin-left: 50px;left: -70px;" name="save">save</button>
				</form>
				 <h3>'.$Nickname.'</h3>
                </div>
              </div>
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  ...
                  <li><a href="friends.php?friend_email='.$email.'">Friends</a></li>
                </ul>
              </div>
            </div>
...
';
$query = "SELECT * FROM post WHERE email='$email' ORDER BY postedtime DESC";
if($query_fetched = mysqli_query($connection,$query))
{
