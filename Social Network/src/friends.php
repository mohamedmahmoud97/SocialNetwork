...
';
$query = "SELECT myfriendEmail FROM friend WHERE myEmail='$friend_email'";
if($query_fetched = mysqli_query($connection,$query))
{
                    ...
                    <div class="friend-card">
                      ...
                      <div class="card-info">
                        ...
                        <div class="friend-info">
                          ...
                          <h5><a href="Friendprofile.php?friend_email='.$mail.'" class="profile-link">'.$name.'</a></h5>
