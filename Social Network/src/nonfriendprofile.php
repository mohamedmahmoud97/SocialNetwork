...
$nonfriend_email = $_GET['nonfriend_email'];
$query = "SELECT * FROM users WHERE email = '$nonfriend_email'";
          ...
          <div class="navbar-mobile hidden-lg hidden-md">
            ...
            <div class="mobile-menu">
              <ul class="list-inline">
                <li><a href="nonfriendprofile.php?friend_email='.$nonfriend_email.'" class="active">Timeline</a></li>
                <li><a href="Friends.php?email='.$nonfriend_email.'">Friends</a></li>
              </ul>
            </div>
...
';
$query = "SELECT * FROM post WHERE email='$nonfriend_email' && ispublic=TRUE ORDER BY postedtime DESC";
if($query_fetched = mysqli_query($connection,$query))
{
